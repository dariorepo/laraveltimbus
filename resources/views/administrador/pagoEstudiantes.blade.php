                                    ...
                                    <table class="table-info col-20 table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$pagoEstudiante->id}}</td>
                                                <td>{{$pagoEstudiante->identificacion}}</td>
                                                <td>{{$pagoEstudiante->nombre}}</td>
                                                <td>{{$pagoEstudiante->apellido}}</td>
                                                <td>{{$pagoEstudiante->telefono}}</td>
                                                <td>{{$pagoEstudiante->correo}}</td>
                                                <td>{{$pagoEstudiante->institucion}}</td>
                                                <td>{{$pagoEstudiante->password}}</td>
                                                <td>{{$pagoEstudiante->created_at}}</td>


                                                <td>
                                                    <a href="{{ route('editPagoEstudiante', $pagoEstudiante) }}">
                                                        <button type="button"
                                                            class="btn-warning btn-sm">editar</button></a>

                                                    <form
                                                        action="{{ route('eliminarPagoEstudiante.destroy', $pagoEstudiante) }}"
