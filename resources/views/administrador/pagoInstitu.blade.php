                                    ...
                                    <table class="table-info col-20 table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('editPagoInstitucion', $pagoInstitucion) }}">

                                                        <button type="button"
                                                            class="btn-warning btn-sm">editar</button></a>

                                                    <form
                                                        action="{{ route('eliminarPagoInstitucion.destroy', $pagoInstitucion) }}" class="d-inline" method="POST">
