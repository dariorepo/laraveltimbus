        ...
        <div class="sidebar-wrapper">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route('buscarInstitucion') }}">
...
<form action="{{route('actualizarPerfil2Update', $estudiantes2 )}}" method="POST">
    {{--  --}}
    {{-- ->toArray() --}}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" name="telefono" class="form-control" value="{{$estudiantes2->telefono}}" />
            </div>
        </div>
    </div>
