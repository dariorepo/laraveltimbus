                ...
                <div class="card custom-user-info-card">
                  <div class="card-body custom-user-table-data">
                      <table class="table">
                              ...
                              <h2>Datos de la Institucion</h2><br>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <a href="{{ route('empresaInv.edit_instVinculadas', $institucion) }}">
                                                    <button type="button" class="btn-warning btn-sm">editar</button></a> --}}


                                                <form action="{{ route('desvincularInst.destroy', $institucion) }}" class="d-inline" method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit" class="btn btn-danger btn-sm">Desvincular</button></a>
                                                </form>
                                        </td>
