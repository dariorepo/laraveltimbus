        ...
        >
          <div class="container-fluid">
            <div class="navbar-wrapper">
              <a class="navbar-brand" href="javascript:;">Registro Vehiculo</a>
            </div>
            <button
                    ...
                    <div class="table-responsive">
                      ...
                      <article class="principal d-flex justify-content-center">
                        <form class="form_reg" action="">
                          ...
                          <p></p>
                          <input type="text" placeholder="Soat">
                          <p></p>
                          <input type="text" placeholder="Modelo vehiculo">
                          <p></p>
                          <input type="text" placeholder="cilindraje">
                          <p></p>
                          <input type=" tex" placeholder="licencia ">
                          <p></p>
                          <div class="reg">
