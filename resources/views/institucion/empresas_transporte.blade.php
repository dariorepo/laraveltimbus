      ...
      >
        <div class="logo">
          <a href="./index.html" class="simple-text logo-normal">
            <img src="../images/champaña.jpg" alt="logo" />
          </a>
        </div>
        ...
        >
          <div class="container-fluid">
            <div class="navbar-wrapper">
              <a class="navbar-brand" href="javascript:;">Empresas Transporte</a>
            </div>
            <button
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <div>
                          ...
                          <h2>Empresas Vinculadas</h2><br>
                              <h2>COOPERATIVA DE MOTORISTAS DEL CAUCA</h2><br>
                              <h2>COOPERATIVA INTEGRAL DE TAXIS BELALCAZAR</h2><br>
          
          
                              <h2>SILOGISTICA S A S</h2><br>
                              <h2>SOCIEDAD TRANSPORTADORA DEL CAUCA S A</h2><br>
          
                             <h2>SOTRACAUCA METTRO S A</h2><br>
                              <h2>TRANSPORTES TIERRA DEL SOL E A T</h2><br>
          
                              <h2>COOPERATIVA TRANSPORTADORA DE TIMBIO COOTRANSTIMBIO</h2><br>
          
          
                              <h2>TRANSPORTE ADECUACION Y VIAS G G S A S</h2><br>
                              <h2>TRANSPORTADORA LIBERTAD S A S</h2><br>
                            
                              <h2>TRANSPORTES PUBENZA LTDA</h2><br>
