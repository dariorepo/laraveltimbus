                  ...
                  <div class="card-body custom-user-table-data">
                    <div class="table-responsive">
                      ...
                      <article class="principal d-flex justify-content-center">
                        ...
                        <form class="form_reg" action="{{ Route('registroVehiculo.store') }}" method="POST">
                            @csrf
                            ...
                            <input type="text" name="modelo" placeholder="Modelo vehiculo"><br>

                            <input type="text" name="soat" placeholder="Soat"><br>

                            <input type="text" name="cilindraje" placeholder="Cilindraje">
