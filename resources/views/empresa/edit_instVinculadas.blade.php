...
<body>
        <article class="principal d-flex justify-content-center"><br>
            ...
            <form class="form_reg" action="{{route('editarEnv.edit', $institucion)}}" method="POST">
                ...
                <input type="number" name="telefono" placeholder="telefono" value="{{$institucion->telefono}}">
                <br>
