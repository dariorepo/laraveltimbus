                  ...
                  <div class="card-body custom-user-table-data">
                    <div class="table-responsive">
                       ...
                       <table class=" table table-bordered table-hover ">
                           ...
                           <tbody>
                            @foreach ($pagoInstituciones as $pagoInstitucion )

                            <tr class="table-success">
                                <td>{{$pagoInstitucion->nombre_institucion}}</td>
                                <td>{{$pagoInstitucion->telefono}}</td>
                                <td>{{$pagoInstitucion->correo}}</td>
                                <td>{{$pagoInstitucion->medio_pago}}</td>
                                <td>{{$pagoInstitucion->monto}}</td>
                                <td>{{$pagoInstitucion->created_at}}</td>


                                <td>
                                    {{-- <a href="{{ route('editarPagoInstituciones', $pagoInstitucion)}}">

                                           <button type="button" class="btn-warning btn-sm">editar</button>
                                        </a> --}}

                                        <form action="{{ route('eliminarPagoInst.destroy', $pagoInstitucion) }}" class="d-inline" method="POST">
                                            @method('DELETE')
                                            @csrf
                                            <button type="submit" class="btn btn-danger btn-sm">Eiminar</button></a>
                                        </form>
                               </td>
                            </tr>
                            @endforeach
                            {{$pagoInstituciones->links()}}
